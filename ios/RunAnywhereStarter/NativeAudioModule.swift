...
class NativeAudioModule: NSObject, AVSpeechSynthesizerDelegate {
  ...
  /// Extract plain text from a PDF on-device using PDFKit. No network involved.
  @objc(extractPdfText:withResolver:withRejecter:)
  func extractPdfText(_ path: String,
    ...
    guard let doc = PDFDocument(url: url) else {
      reject("pdf_open_failed", "Could not open the PDF file.", nil)
      return
    }
    var text = ""
